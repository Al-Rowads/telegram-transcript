...
def test_load_settings_uses_defaults() -> None:
    ...
    assert settings.openrouter_refine_model == "google/gemini-2.5-flash-lite"
    assert settings.openrouter_transcription_refinement_model == "google/gemini-2.5-flash-lite"
